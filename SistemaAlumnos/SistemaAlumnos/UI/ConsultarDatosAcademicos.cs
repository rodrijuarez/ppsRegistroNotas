       ...
       private void CargarDgv()
        {
            ...
            if (cboCriterio.SelectedIndex == 0)
            {
                ...
                dgvTablaAlumnos.DataSource = Datos.DatosAlumno.TraerTodosPorApellido(txtIngreso.Text);
            }
            else
            {
                dgvTablaAlumnos.DataSource = Datos.DatosAlumno.TraerTodosPorLegajo(txtIngreso.Text);
            }
        }
